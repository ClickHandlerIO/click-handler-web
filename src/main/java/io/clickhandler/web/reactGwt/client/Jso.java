...
public interface Jso {
    ...
    static <T> T create(Class<T> cls, io.clickhandler.web.reactGwt.client.Func.Run1<T> callback) {
        final T jso = create();
    ...
    class Native {
        ...
        public static native void iterate(Object obj, io.clickhandler.web.reactGwt.client.Func.Run2<String, Object> callback) /*-{
            if (!callback || !obj) {
                return;
            }
