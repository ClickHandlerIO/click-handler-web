...
public abstract class ModuleLoader {
    ...
    private io.clickhandler.web.reactGwt.client.router.Location location;
    private io.clickhandler.web.reactGwt.client.router.RoutesCallback callback;
    ...
    public io.clickhandler.web.reactGwt.client.router.Location getLocation() {
        return location;
    }

    public io.clickhandler.web.reactGwt.client.router.RoutesCallback getCallback() {
        return callback;
    }
     ...
     * @param callback
     */
    protected void handle(final String relativePath, final io.clickhandler.web.reactGwt.client.router.Location location, io.clickhandler.web.reactGwt.client.router.RoutesCallback callback) {
