...
import io.clickhandler.web.reactGwt.client.BusDelegate;
...
public class ActionCall<IN, OUT> implements HandlerRegistration {
    ...
    private IN request;
    private io.clickhandler.web.reactGwt.client.action.ErrorCallback errorCallback;
    private io.clickhandler.web.reactGwt.client.action.ResponseCallback<OUT> response;
    private Func.Run willSend;
    private io.clickhandler.web.reactGwt.client.action.AlwaysCallback alwaysCallback;
     ...
     * @return
     */
    public ActionCall<IN, OUT> onResponse(io.clickhandler.web.reactGwt.client.action.ResponseCallback<OUT> callback) {
     ...
     * @return
     */
    public ActionCall onError(io.clickhandler.web.reactGwt.client.action.ErrorCallback errorCallback) {
     ...
     * @return
     */
    public ActionCall<IN, OUT> always(io.clickhandler.web.reactGwt.client.action.AlwaysCallback alwaysCallback) {
