...
public class BusDelegate implements HandlerRegistration {
    private final io.clickhandler.web.reactGwt.client.Bus delegate;
    private ArrayList<HandlerRegistration> registrations;

    public BusDelegate(io.clickhandler.web.reactGwt.client.Bus delegate) {
     ...
     * @return
     */
    public <T> HandlerRegistration subscribe(io.clickhandler.web.reactGwt.client.Bus.TypeName<T> named, EventCallback<T> callback) {
     ...
     * @param <T>
     */
    public <T> void publish(io.clickhandler.web.reactGwt.client.Bus.TypeName<T> name, T event) {
