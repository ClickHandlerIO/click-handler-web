...
public class HTMLProps<T> extends DOMProps<T> {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCopy(io.clickhandler.web.reactGwt.client.event.ClipboardEventHandler value) {
        super.onCopy(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCut(io.clickhandler.web.reactGwt.client.event.ClipboardEventHandler value) {
        super.onCut(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onPaste(io.clickhandler.web.reactGwt.client.event.ClipboardEventHandler value) {
        super.onPaste(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCompositionEnd(io.clickhandler.web.reactGwt.client.event.CompositionEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCompositionStart(io.clickhandler.web.reactGwt.client.event.CompositionEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCompositionUpdate(io.clickhandler.web.reactGwt.client.event.CompositionEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onFocus(io.clickhandler.web.reactGwt.client.event.FocusEventHandler value) {
        super.onFocus(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onBlur(io.clickhandler.web.reactGwt.client.event.FocusEventHandler value) {
        super.onBlur(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onChange(io.clickhandler.web.reactGwt.client.event.FormEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onInput(io.clickhandler.web.reactGwt.client.event.FormEventHandler value) {
        super.onInput(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onSubmit(io.clickhandler.web.reactGwt.client.event.FormEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onLoad(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onLoad(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onError(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onError(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onKeyDown(io.clickhandler.web.reactGwt.client.event.KeyboardEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onKeyPress(io.clickhandler.web.reactGwt.client.event.KeyboardEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onKeyUp(io.clickhandler.web.reactGwt.client.event.KeyboardEventHandler value) {
        super.onKeyUp(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onAbort(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onAbort(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCanPlay(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onCanPlayThrough(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDurationChange(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onEmptied(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onEncrypted(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onEnded(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onEnded(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onLoadedData(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onLoadedMetadata(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onLoadStart(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onPause(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onPause(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onPlay(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
        super.onPlay(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onPlaying(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onProgress(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onRateChange(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onSeeked(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onSeeking(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onStalled(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onSuspend(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onTimeUpdate(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onVolumeChange(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onWaiting(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onClick(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
        super.onClick(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onContextMenu(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDoubleClick(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDrag(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
        super.onDrag(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragEnd(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragEnter(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragExit(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragLeave(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragOver(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDragStart(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onDrop(io.clickhandler.web.reactGwt.client.event.DragEventHandler value) {
        super.onDrop(value);
        return this;
    }
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseDown(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseEnter(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseLeave(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseMove(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseOut(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseOver(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onMouseUp(io.clickhandler.web.reactGwt.client.event.MouseEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onSelect(io.clickhandler.web.reactGwt.client.event.ReactEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onTouchCancel(io.clickhandler.web.reactGwt.client.event.TouchEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onTouchEnd(io.clickhandler.web.reactGwt.client.event.TouchEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onTouchMove(io.clickhandler.web.reactGwt.client.event.TouchEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onTouchStart(io.clickhandler.web.reactGwt.client.event.TouchEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onScroll(io.clickhandler.web.reactGwt.client.event.UIEventHandler value) {
    ...
    @Override
    @JsIgnore
    public HTMLProps<T> onWheel(io.clickhandler.web.reactGwt.client.event.WheelEventHandler value) {
        super.onWheel(value);
        return this;
    }
}
