...
public class Route {
     ...
     */
    @JsProperty
    public io.clickhandler.web.reactGwt.client.router.ChildRouteCallback getIndexRoute;
     ...
     */
    @JsProperty
    public io.clickhandler.web.reactGwt.client.router.ChildRoutesCallback getChildRoutes;
     ...
     */
    @JsProperty
    public io.clickhandler.web.reactGwt.client.router.GetComponentsCallback getComponents;

    /**
     *
     */
    @JsProperty
    public io.clickhandler.web.reactGwt.client.router.OnEnterRoute onEnter;

    /**
     *
     */
    @JsProperty
    public io.clickhandler.web.reactGwt.client.router.OnLeaveRoute onLeave;
    ...
    @JsIgnore
    public Route getComponents(io.clickhandler.web.reactGwt.client.router.GetComponentsCallback getComponents) {
    ...
    @JsIgnore
    public Route getIndexRoute(io.clickhandler.web.reactGwt.client.router.ChildRouteCallback getIndexRoute) {
    ...
    @JsIgnore
    public Route getChildRoutes(io.clickhandler.web.reactGwt.client.router.ChildRoutesCallback getChildRoutes) {
        this.getChildRoutes = getChildRoutes;
        return this;
    }

    @JsIgnore
    public Route onEnter(io.clickhandler.web.reactGwt.client.router.OnEnterRoute onEnter) {
        this.onEnter = onEnter;
        return this;
    }

    @JsIgnore
    public Route onLeave(io.clickhandler.web.reactGwt.client.router.OnLeaveRoute onLeave) {
