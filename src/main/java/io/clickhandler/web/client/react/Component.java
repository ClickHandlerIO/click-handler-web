...
import io.clickhandler.web.client.dom.CSSProps;
...
public abstract class Component<P, S> {
    ...
    public io.clickhandler.web.client.Func.Run2<P, S> componentDidUpdate = io.clickhandler.web.client.Func.bind(this::componentDidUpdate0);
    @JsProperty
    public io.clickhandler.web.client.Func.Run componentDidMount = io.clickhandler.web.client.Func.bind(this::componentDidMount0);
    @JsProperty
    public io.clickhandler.web.client.Func.Run componentWillUnmount = io.clickhandler.web.client.Func.bind(this::componentWillUnmount0);
    @JsProperty
    public io.clickhandler.web.client.Func.Run1<P> componentWillReceiveProps = io.clickhandler.web.client.Func.bind(this::componentWillReceiveProps0);
    @JsProperty
    public io.clickhandler.web.client.Func.Call<P> getDefaultProps = io.clickhandler.web.client.Func.bind(this::getDefaultProps);
    @JsProperty
    public io.clickhandler.web.client.Func.Run2<P, S> componentWillUpdate = io.clickhandler.web.client.Func.bind(this::componentWillUpdate0);
    @JsProperty
    public io.clickhandler.web.client.Func.Call<S> getInitialState = io.clickhandler.web.client.Func.bind(this::getInitialState);
    @JsProperty
    public io.clickhandler.web.client.Func.Call2<Boolean, P, S> shouldComponentUpdate = io.clickhandler.web.client.Func.bind(this::shouldComponentUpdate0);
    @JsProperty(name = "render")
    public io.clickhandler.web.client.Func.Call<ReactElement> render = io.clickhandler.web.client.Func.bind(this::render0);
    ...
    @JsProperty
    public io.clickhandler.web.client.Func.Call getChildContext = this::getChildContext;
    @Inject
    io.clickhandler.web.client.Bus bus;
    @JsProperty
    public io.clickhandler.web.client.Func.Run componentWillMount = io.clickhandler.web.client.Func.bind(this::componentWillMount0);
    @Inject
    History history;
    ...
    public static <T> T create() {
        return io.clickhandler.web.client.Jso.create();
    }
    ...
    @JsIgnore
    public static <T> T create(Class<T> cls, io.clickhandler.web.client.Func.Run1<T> callback) {
        return io.clickhandler.web.client.Jso.create(cls, callback);
    }
    ...
    protected ReactElement render0(final ReactComponent<P, S> $this) {
        ...
        io.clickhandler.web.client.react.ChildCounter.get().scope();
        try {
            if (props != null) {
                // Fix children not having a "key" set.
                Object children = io.clickhandler.web.client.Reflection.get(props, "children");
                if (children != null) {
                    Object key = io.clickhandler.web.client.Reflection.get(children, "key");

                    if (key == null) {
                        // Create a new key.
                        key = io.clickhandler.web.client.react.ChildCounter.get().newKey();
                        // Try to set it on children.
                        io.clickhandler.web.client.Reflection.set(children, "key", key);

                        // Test that key was set properly.
                        if (io.clickhandler.web.client.Reflection.get(children, "key") != key) {
                            // Copy to new "children" object.
                            final Object newChildren = new Object();
                            io.clickhandler.web.client.Reflection.assign(newChildren, children);
                            // Set key.
                            io.clickhandler.web.client.Reflection.set(newChildren, "key", key);
                            // Set new "children" on props.
                            io.clickhandler.web.client.Reflection.set(props, "children", newChildren);
                        }
                    }
                }
            }
            ...
            io.clickhandler.web.client.react.ChildCounter.get().pop();
        }
    }
    ...
    private void componentWillMount0(final ReactComponent<P, S> $this) {
        io.clickhandler.web.client.Reflection.set($this, io.clickhandler.web.client.react.React.BUS, new io.clickhandler.web.client.BusDelegate(bus));
    ...
    public ReactClass getReactClass() {
        if (reactClass == null) {
            reactClass = io.clickhandler.web.client.react.React.createClass(this);
        }
    ...
    protected P props() {
        ...
        // Set key manually.
        Object key = io.clickhandler.web.client.Reflection.get(props, "key");
        if (key == null) {
            io.clickhandler.web.client.Reflection.set(props, "key", io.clickhandler.web.client.react.ChildCounter.get().newKey());
        }
    ...
    public ReactElement $(Object... children) {
        return io.clickhandler.web.client.react.React.createElement(getReactClass(), props(), children);
    }
     ...
     */
    public ReactElement $() {
        return io.clickhandler.web.client.react.React.createElement(getReactClass(), props());
    }
     ...
     * @return
     */
    public ReactElement $(P props, io.clickhandler.web.client.Func.Run1<DOM.ChildList> childCallback) {
        final DOM.ChildList childList = new DOM.ChildList();
        if (childCallback != null) {
            childCallback.run(childList);
        }
        return io.clickhandler.web.client.react.React.createElement(getReactClass(), props, childList.toArray());
    }
     ...
     * @return
     */
    public ReactElement $(io.clickhandler.web.client.Func.Run1<P> propsCallback, io.clickhandler.web.client.Func.Run1<DOM.ChildList> childCallback) {
        final P props = props();
     ...
     * @return
     */
    public ReactElement $(io.clickhandler.web.client.Func.Run2<P, DOM.ChildList> callback) {
        final P props = props();
        final DOM.ChildList childList = new DOM.ChildList();
        if (callback != null) {
     ...
     * @return
     */
    public ReactElement $(io.clickhandler.web.client.Func.Run1<P> propsCallback) {
        final P props = props();
        if (propsCallback != null) {
            propsCallback.run(props);
        }
     ...
     * @return
     */
    public ReactElement $(io.clickhandler.web.client.Func.Run1<P> propsCallback, Object... children) {
        final P props = props();
        if (propsCallback != null) {
            propsCallback.run(props);
        }
     ...
     * @return
     */
    public ReactElement $$(io.clickhandler.web.client.Func.Run1<DOM.ChildList> childCallback) {
        final P props = props();
        final DOM.ChildList childList = new DOM.ChildList();
        if (childCallback != null) {
            childCallback.run(childList);
    ...
    public static class ContextTypes {
        ...
        public <T> T get(String name) {
            return io.clickhandler.web.client.Reflection.get(this, name);
        }

        @JsIgnore
        public <T> void set(String name, T value) {
            io.clickhandler.web.client.Reflection.set(this, name, value);
        }
    }
}
