...
import io.clickhandler.web.client.JSON;
...
public class WsDispatcher {
    ...
    public <T> HandlerRegistration subscribe(io.clickhandler.web.client.remoting.PushSubscription<T> subscription) {
    ...
    public <T> void simulatePush(String address, T event) {
        final io.clickhandler.web.client.remoting.WsEnvelope envelope = io.clickhandler.web.client.remoting.WsEnvelope.Factory.create()
            .method(io.clickhandler.web.client.remoting.WsEnvelope.Constants.PUSH)
            .type(address)
    ...
    public void simulate(io.clickhandler.web.client.remoting.WsEnvelope envelope) {
    ...
    private void connected() {
        Try.run(() -> bus.publish(new io.clickhandler.web.client.remoting.WsConnectedEvent(this)));
     ...
     */
    private void closed() {
        Try.run(() -> bus.publish(new io.clickhandler.web.client.remoting.WsClosedEvent(this)));
    ...
    private void data(String payload) {
        // Parse envelope.
        final io.clickhandler.web.client.remoting.WsEnvelope envelope = io.clickhandler.web.client.remoting.WsEnvelope.Factory.parse(payload);
        ...
        bus.publish(new io.clickhandler.web.client.remoting.WsEnvelopeEvent(this, envelope));

        switch ((int) envelope.method()) {
            case io.clickhandler.web.client.remoting.WsEnvelope.Constants.IN:
                // Incoming request.
                break;
            case io.clickhandler.web.client.remoting.WsEnvelope.Constants.OUT:
                // It's a response.
                ...
                break;
            case io.clickhandler.web.client.remoting.WsEnvelope.Constants.PUSH:
                // It's a push event.
    ...
    public void request(Bus.TypeName inType,
                        ...
                        String type,
                        String payload,
                        Func.Run1<io.clickhandler.web.client.remoting.WsEnvelope> callback,
                        Func.Run timeoutCallback) {
        final io.clickhandler.web.client.remoting.WsEnvelope envelope = io.clickhandler.web.client.remoting.WsEnvelope.Factory.create(
            io.clickhandler.web.client.remoting.WsEnvelope.Constants.IN,
            nextId(),
            0,
            type,
            payload
    ...
    private static final class Outgoing {
        ...
        private final io.clickhandler.web.client.remoting.WsEnvelope envelope;
        private final Func.Run1<io.clickhandler.web.client.remoting.WsEnvelope> callback;
        ...
        public Outgoing(Bus.TypeName inType,
                        ...
                        long started,
                        int timeoutMillis,
                        io.clickhandler.web.client.remoting.WsEnvelope envelope,
                        Func.Run1<io.clickhandler.web.client.remoting.WsEnvelope> callback,
                        Func.Run timeoutCallback) {
            this.inType = inType;
    ...
    private class AddressSubscription<T> implements HandlerRegistration {
        ...
        private ArrayList<io.clickhandler.web.client.remoting.PushSubscription> subs = new ArrayList<>();
        ...
        public void removeHandler() {
            ...
            for (io.clickhandler.web.client.remoting.PushSubscription sub : subs) {
                sub.removeHandler();
            }
            ...
            send(
                new Outgoing(
                    ...
                    new Date().getTime(),
                    DEFAULT_SUB_TIMEOUT,
                    io.clickhandler.web.client.remoting.WsEnvelope.Factory.create(io.clickhandler.web.client.remoting.WsEnvelope.Constants.USUB, nextId(), 0, name, null),
        ...
        public void subscribeToServer() {
            ...
            send(
                new Outgoing(
                    ...
                    new Date().getTime(),
                    DEFAULT_SUB_TIMEOUT,
                    io.clickhandler.web.client.remoting.WsEnvelope.Factory.create(io.clickhandler.web.client.remoting.WsEnvelope.Constants.SUB, nextId(), 0, name, null),
                    envelope -> {
        ...
        public void receive(String json) {
            ...
            for (io.clickhandler.web.client.remoting.PushSubscription subscription : subs) {
         ...
         * @return
         */
        public HandlerRegistration subscribe(io.clickhandler.web.client.remoting.PushSubscription subscription) {
         ...
         * @param sub
         */
        private void unsubscribe(io.clickhandler.web.client.remoting.PushSubscription sub) {
            subs.remove(sub);
            sub.removeHandler();
