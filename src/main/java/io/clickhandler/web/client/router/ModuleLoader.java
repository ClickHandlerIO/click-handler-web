...
public abstract class ModuleLoader {
    ...
    private io.clickhandler.web.client.router.Location location;
    private io.clickhandler.web.client.router.RoutesCallback callback;
    ...
    public io.clickhandler.web.client.router.Location getLocation() {
        return location;
    }

    public io.clickhandler.web.client.router.RoutesCallback getCallback() {
        return callback;
    }
     ...
     * @param callback
     */
    protected void handle(final String relativePath, final io.clickhandler.web.client.router.Location location, io.clickhandler.web.client.router.RoutesCallback callback) {
